...
- Completed current-native live-host acceptance for Codex, Claude Code, GitHub Copilot CLI, and the previously observed guarded OpenCode project-local journey; the public acceptance projection records those accepted observations while private release authorization remains separate.
