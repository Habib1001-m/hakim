# Hakim Gemini / Antigravity Integration Placeholder

Hakim `1.0.0-beta.1` does not publish or maintain an installable Gemini or
Antigravity adapter. This directory is retained only as a compatibility
placeholder in the public source tree.
